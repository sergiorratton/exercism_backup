...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    limite_normal_superior = 1.1 * threshold
    limite_normal_inferior = 0.9 * threshold
    # return_list = {'LOW',
    #               'NORMAL',
    #               'DANGER'}
    if temp_neutrons < limite_normal_inferior:
        return 'LOW'
    elif temp_neutrons >= limite_normal_inferior and temp_neutrons <= limite_normal_superior:
        return 'NORMAL'
    else:
        return 'DANGER'